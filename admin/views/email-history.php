...
<div class="wrap">
    ...
    <form method="get" style="margin: 12px 0;">
        ...
        <input type="search" name="s" value="<?php echo esc_attr($search); ?>" placeholder="<?php echo esc_attr(__('Search recipient or subject', 'multisite-network-email-manager')); ?>" class="regular-text" />
                    ...
                    <tr>
                        ...
                        <td>
                            <button
                                ...
                                data-email-id="<?php echo esc_attr((string) (isset($item['email_id']) ? (int) $item['email_id'] : 0)); ?>"
